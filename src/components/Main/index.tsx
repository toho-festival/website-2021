...
const Main: FC = () =>
  <>
    <Project right={ 0 } left={ 10 }><Band src='/band808080.png' side='left'/><Experience src='/experience.png'
      ...
      side='left'>{ projectsTitle[0] }</ProjectTitle><ProjectComment marginLeft={ 40 }>{ projectsComment[0] }</ProjectComment></Project>
    <Reset/><Project right={ 10 } left={ 0 }><Band src='/band808080.png' side='right'/><Exhibit src='/exhibit.png'
                                                                                                side='right'/><ProjectTitle
    side='right'>{ projectsTitle[1] }</ProjectTitle><ProjectComment marginLeft={ 45 }>{ projectsComment[1] }</ProjectComment></Project>
    <Reset/><Project right={ 0 } left={ 10 }><Band src='/band808080.png' side='left'/><Music src='/music.png'
                                                                                             side='left'/><ProjectTitle
    side='left'>{ projectsTitle[2] }</ProjectTitle><ProjectComment marginLeft={ 40 }>{ projectsComment[2] }</ProjectComment></Project>
    <Reset/>
    <SubContents/>
  </>;
